...
| `SUITE-AUTHORING.md` | The mcp-e2e harness's suite-authoring contract (maintainer-delivered distillation) |
...
| `96-rulings.md` | Maintainer rulings R1–R21 (2026-08-29 → 2026-09-21) with the Q1 source exchange (S5) |
